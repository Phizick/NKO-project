        ...
        <div className={ styles.forWhat }>
            ...
            <ul className={ styles.list }>
                <li className={ styles.item }>
                    <Image src={personal} className={styles.image} alt='Персонал' />
                ...
                <li className={ styles.item }>
                    <Image src={brushes} className={styles.image} alt='Инвентарь' />
                    <div className={styles.itemTextBlock}>
                ...
                <li className={ styles.item }>
                    <Image src={box} className={styles.image} alt='Логистика' />
                    <div className={styles.itemTextBlock}>
