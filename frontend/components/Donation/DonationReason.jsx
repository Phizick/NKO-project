		...
		<div className={styles.donate__reasons}>
			...
			<ul className={styles.donate__reasonsList}>
					<li className={styles.donate__reason}>
						<Image className={styles.donate__reasonImage} src={staffImage} alt="схематичное изображение человека" />
					...
					<li className={styles.donate__reason}>
						<Image className={styles.donate__reasonImage} src={inventoryImage} alt="схематичное изображение двух кисточек" />
						<div className={styles.donate__text}>
					...
					<li className={styles.donate__reason}>
						<Image className={styles.donate__reasonImage} src={logisticsImage} alt="схематичное изображение коробки" />
						<div className={styles.donate__text}>
